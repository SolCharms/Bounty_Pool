...
pub enum ErrorCode {
    ...
    #[msg("The bounty period has expired")]
    BountyPoolHasEnded, //0x177A

    #[msg("The bounty period has not yet expired")]
    BountyPoolHasNotEnded, //0x177B

    #[msg("The bounty has already been awarded")]
    BountyAlreadyAwarded, //0x177C

    #[msg("The bounty has not yet been awarded")]
    BountyNotYetAwarded, //0x177D

    #[msg("Not all bounty pool contribution PDAs are yet closed")]
    NotAllBountyPoolPDAsClosed, //0x177E

    #[msg("There are two or more nominees tied with the largest vote total")]
    TiedAtopScoreboard, //0x177F

    #[msg("Cannot extend time as there is no tie atop scoreboard")]
    NotTiedAtopScoreboard, //0x1780

    #[msg("No votes have been cast for any nominees")]
    NoVotesCast, //0x1781

    #[msg(" New bounty pool ends timestamp must supersede now_ts")]
    InvalidNewBountyPoolEndsTs, //0x1782
